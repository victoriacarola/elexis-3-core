...
public class LabeledInputField extends Composite {
	 ...
	 * @param parent
	 * @param label  the label to show above the field
	 * @param typ    the type of field to create. One of LabeledInputField.Typ
	 */
	...
	public static class InputData {
		 ...
		 *
		 * @param anzeige  String, the label shown above the field
		 * @param feldname the database field name
		 * @param feldtyp  field type to use, one of InputData.Typ
		 * @param hashname the name of the field in the hashfield, set to null if
		 *                 feldname is not a hash
		 */
		 ...
		 * @param hashname the name of the field in the hashfield, set to null if
		 *                 feldname is not a hash
		 * @param limit    the max. allow characters for this field
		 */
		 ...
		 *
		 * @param all the fieldname, also used for the label
		 */
		 ...
		 * @param anzeige  String, the label shown above the field
		 * @param feldname the database field name
		 * @param cp       an IContentProvider used to display the contents
		 */
		 ...
		 * @param hashname the name of the field in the hashfield, set to null if
		 *                 feldname is not a hash
		 * @param choices  the items to be displayed in the list
		 */
		 ...
		 * @param hashname   the name of the field in the hashfield, set to null if
		 *                   feldname is not a hash
		 * @param comboItems the items to be displayed in the combo
		 * @param bDropDown  just to select this method - not used actually...
		 */
	...
	public static class AutoForm extends Tableau implements IUnlockable {
		...
		protected void save(InputData inp) {
			...
			case LIST:
				...
				break;
			case CHECKBOX:
				val = (((Button) (inp.mine.getControl())).getSelection() == true) ? StringConstants.ONE
