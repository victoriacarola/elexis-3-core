...
public enum Images {
	...
	IMG_PRINT_FIX,
	/** a big printer icon */
	IMG_PRINT_RESERVE, IMG_PRINT_SYMPTOMATIC,
	/** a filter */
	IMG_FILTER, IMG_FOLDER,
	...
	/** editing an item */
	IMG_EDIT, IMG_EDIT_DONE, IMG_EDIT_ABORT,
	/** warning */
	IMG_ACHTUNG,
	/** red bullet */
	IMG_BULLET_RED,
	...
	IMG_DISK,
	/** a closed lock */
	IMG_LOCK_CLOSED, IMG_LOCK_CLOSED_YELLOW, IMG_LOCK_CLOSED_GREEN, IMG_LOCK_CLOSED_GREY,
	/** An opened lock */
	IMG_LOCK_OPEN,
	/** View lock */
	IMG_LOCK_CO,
	...
	IMG_DOCUMENT_WRITE,
	/** remove document */
	IMG_DOCUMENT_REMOVE, IMG_DOCUMENT_CONVERT, IMG_MENUBAR, IMG_TOOLBAR,
	/** recipe */
	IMG_RECIPE_FIX, IMG_RECIPE_RESERVE, IMG_RECIPE_SYMPTOMATIC,
	/** a bill */
	IMG_BILL, IMG_VIEW_WORK_INCAPABLE, IMG_VIEW_CONSULTATION_DETAIL, IMG_VIEW_LABORATORY, IMG_VIEW_PATIENT_DETAIL,
	IMG_VIEW_RECIPES, IMG_DATABASE, IMG_CONFLICT, IMG_QUESTION_MARK, IMG_FLAG_AT, IMG_FLAG_DE, IMG_FLAG_CH, IMG_FLAG_FR,
	IMG_FLAG_IT, IMG_FLAG_FL,
	...
	IMG_WIZ_DAY, IMG_CALENDAR, IMG_COUNTER_STOP, IMG_USER_IDLE, IMG_SYSTEM_MONITOR, IMG_BELL_EXCLAMATION, IMG_SORT_DATE,
	IMG_SORT_DATE_DESCENDING, IMG_CARDS, IMG_NOBILLING, IMG_BAGGAGE_CART_BOX, IMG_HAND, IMG_CLOCK, IMG_TASK,
	IMG_SCANNER, IMG_SCANNER_BARCODE, IMG_DRAWER, IMG_DRAWER_ARROW, IMG_ADD, IMG_INBOX, IMG_OUTBOX, IMG_SERVER_PENCIL;
	 ...
	 * disposed automatically. Defaults to {@link ImageSize#_16x16_DefaultIconSize}
	 *
	 ...
	 * There may exist keys within the <code>iconset.properties</code> file which
	 * are not managed by this Enumeration. This method allows an opportunistic
	 * lookup of such registered images.
	 *
	 * @param iconKey
	...
	/**
	 * @return a string to be embedded as iconURI, see beta plugin process for an
	 *         example
	 */
	...
	/**
	 * Return a resized (software scaled) version of an image, image will not be
	 * disposed
	 *
	 * @param image  the image to resize
	 * @param width
