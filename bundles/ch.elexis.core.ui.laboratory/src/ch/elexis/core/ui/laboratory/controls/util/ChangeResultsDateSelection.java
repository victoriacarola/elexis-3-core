...
public class ChangeResultsDateSelection extends SelectionAdapter {
	...
	public ChangeResultsDateSelection(TreeViewerColumn column, LaborResultsComposite laborResultsComposite) {
		this.column = column;
	...
	public void widgetSelected(SelectionEvent e) {
		...
		DateTimeSelectorDialog dsd = new DateTimeSelectorDialog(composite.getShell(),
				date != null ? date : new TimeTool());
